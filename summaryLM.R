...
summaryModel <- summary(lm(formula = SatisfactionNumeric ~ Airline.Status + Age + Gender + Price.Sensitivity + Year.of.First.Flight + No.of.Flights.p.a. + X..of.Flight.with.other.Airlines +
  ...
  Class + Scheduled.Departure.Hour + Flight.Distance + Arrival.Delay.greater.5.Mins, data = cleanSatisfactionSurvey))
...
# Airline.Code + Day.of.Month + Departure.Delay.in.Minutes + Arrival.Delay.in.Minutes + 
