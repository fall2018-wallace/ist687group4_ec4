...
histPrice <- hist(satisfactionSurvey$Price.Sensitivity)
...
histFirstFlight <- hist(satisfactionSurvey$Year.of.First.Flight)
...
histNoFlights <- hist(satisfactionSurvey$No.of.Flights.p.a.)
...
histFlightsOther <- hist(satisfactionSurvey$X..of.Flight.with.other.Airlines)
